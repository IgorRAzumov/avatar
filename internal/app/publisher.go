...
func NewPublisher(
	...
	imageProcessor := processor.NewImageProcessor(readRepository, writeRepository, filesRepository)
	...
	asyncPublisher := processor.NewAsyncPublisher(imageProcessor, log)
